...
const ProjectCard = ({image, name, description}) => {
  return (
    <div className="border border-gray-400 rounded-tl-2xl rounded-br-2xl p-2 shadow-2xl my-5 w-96">
      <img
      ...
      <button className="bg-gradient-to-r from-cyan-400 to-violet-900 p-2 mb-4 rounded-3xl w-48">
        Look it up
      </button>
    </div>
  );
